...
TheoryPbv::TheoryPbv(Env& env,
    ...
    d_rewriter(nodeManager(),
               env.getOptions().smt.pbvRwMw,
               env.getOptions().smt.pbvRwAc,
               env.getOptions().smt.pbvRwNnf,
               env.getOptions().smt.pbvRwBool,
               env.getOptions().smt.pbvRwBoolCap,
               env.getOptions().smt.pbvRwShiftZextMerge),
