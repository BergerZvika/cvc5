...
const static std::unordered_map<Kind, std::pair<internal::Kind, std::string>>
    s_kinds{
        ...
        KIND_ENUM(PIAND, internal::Kind::PIAND),
        KIND_ENUM( PEXTRACT, internal::Kind::PEXTRACT),
        KIND_ENUM( PARAMETRIC_ZERO_EXTEND, internal::Kind::PARAMETRIC_ZERO_EXTEND),
        KIND_ENUM( PARAMETRIC_SIGN_EXTEND, internal::Kind::PARAMETRIC_SIGN_EXTEND),
...
const static std::unordered_map<internal::Kind,
    ...
    s_kinds_internal{
        ...
        {internal::Kind::PIAND, PIAND},
        {internal::Kind::PEXTRACT, PEXTRACT},
        {internal::Kind::PARAMETRIC_ZERO_EXTEND, PARAMETRIC_ZERO_EXTEND},
        {internal::Kind::PARAMETRIC_SIGN_EXTEND, PARAMETRIC_SIGN_EXTEND},
